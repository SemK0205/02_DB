...
-- 추가 샘플 데이터 삽입
-- 가입일 -> SYSDATE 로 삽입
INSERT INTO "MEMBER" VALUES('MEM02', '456ABC' ,'김영희', 
'000215-2234567', SYSDATE );
-- DEFAULT 설정된 컬럼이라고 삽입/수정 시 DEFAULT 만 작성해야 하는 것 아님!
...
-- NOT NULL + UNIQUE 제약조건의 의미 -> 중복되지 않고, 값이 필수로 존재해야함.
...
-- USER_GRADE(부모/참조테이블/레퍼런스테이블)에 10이라는 
-- GRADE_CODE가 존재하므로 가능


INSERT INTO USER_USED_FK VALUES (
2, 'USER02', 'PASS02', '이순신', '남자', 
'010-5678-1234', 'lee_ss@or.kr', 10);
-- USER_GRADE(부모/참조테이블/레퍼런스테이블)에 10이라는 
-- GRADE_CODE가 존재하므로 가능
...
'010-1111-2222', 'yoo_ks@or.kr', 30);
-- USER_GRADE(부모/참조테이블/레퍼런스테이블)에 30이라는 
-- GRADE_CODE가 존재하므로 가능


INSERT INTO USER_USED_FK VALUES (
4, 'USER04', 'PASS04', '안중근', '남자', 
'010-3333-4444', 'ahn_jk@or.kr', NULL);
--> NULL 사용 가능
-- 제공되는 값 외에는 NULL을 사용할 수 있음.
...
'010-5555-6666', 'yoon_bg@or.kr', 50);
