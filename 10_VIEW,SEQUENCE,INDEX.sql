...
-- UPDATE 에서 시퀀스 사용하기
-- '짱구'의 PK 컬럼값을
-- SEQ_TSET_NO 시퀀스의 다음 생성값으로 변경하기
...
--> EMPLOYEE 테이블의 EMP_NAME 컬럼에 대해 빠른검색이 가능
...
-- EMPLOYEE 테이블의 EAMIL 컬럼에 UNIQUE INDEX 생성
...
WHERE TEST_ID = 'TEST500000'; -- 0.025S
